...
deploy_ui() {
    ...
    if ! git clone -b main https://github.com/satech-uic/PDF_accessability_UI "$UI_TEMP_DIR" 2>/dev/null; then
...
GITHUB_URL="https://github.com/satech-uic/PDF_Accessibility.git"
